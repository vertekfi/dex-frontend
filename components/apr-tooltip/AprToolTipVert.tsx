...
function AprToolTipVert({ data, textProps, onlySparkles, placement, aprLabel, sparklesSize }: Props) {
    ...
    return (
        <Popover trigger="hover" placement={placement}>
            ...
            <PopoverTrigger>
                ...
                {!onlySparkles && (
                    <Text fontSize="1rem" fontWeight="semibold" mr="0" color="white" {...textProps}>
