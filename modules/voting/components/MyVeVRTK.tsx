  ...
  return (
    ...
    >
      <Skeleton isLoaded={!!props.currentVeBalance}>
                  ...
                  veVRTK shares: {(props.currentVeBalance && parseFloat(props.currentVeBalance).toFixed(4)) || 'N/A'}
                  </Text>
      

                  <Text  fontSize="1rem" textAlign="center">
                  {(props.percentOwned && parseFloat(props.percentOwned).toFixed(4)) || 'N/A'}% of all veVRTK
                  </Text>
