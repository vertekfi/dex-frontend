import { Modal, Text, ModalOverlay, ModalContent, GridItem, ModalCloseButton,
Grid, Box, Button, Flex } from "@chakra-ui/react";
...
return (
    ...
    <ModalContent minW='90vw' maxW='90vw' bg="vertek.slate.900" paddingY="2rem" borderRadius="12px" >
        <ModalCloseButton />
        <BeetsModalHeader>
            <BeetsModalHeadline textAlign="center" fontSize="1.5rem" color="white" mb="12px" >
                    Lock VRTK-WBNB
            </BeetsModalHeadline>
        </BeetsModalHeader>
        ...
        <Grid pl="4" pr="4" templateColumns={{ base: '1fr 200px 1fr', md: '1fr 400px 1fr' }}>
            <GridItem m="2">
                <Box padding="2" borderRadius="12px" mb="6" bgGradient="linear-gradient(90deg, #302B84 0%, #362BA8 80%, #4132D0 100%)">
                    <Text fontSize="1rem" fontWeight="bold" align="start">
            ...
            <GridItem m="2">
            <Box padding="2" borderRadius="12px" mb="6" bgGradient="linear-gradient(90deg, #302B84 0%, #362BA8 80%, #4132D0 100%)">
                <Text align="left" padding="1" mb="4" fontWeight="bold" color="white" fontSize="1.2rem" textDecoration="uppercase" >Lock to get veVRTK</Text>
                <Text 
                align="left" 
                paddingX="3" mb="0" 
                fontWeight="normal"
            ...
            <GridItem m="2">
            <Box padding="2" borderRadius="12px" mb="6" bgGradient="linear-gradient(90deg, #302B84 0%, #362BA8 80%, #4132D0 100%)">
                <Text fontSize="1rem" fontWeight="bold" align="start">My veVRTK</Text>
                <Box mt="20" >
