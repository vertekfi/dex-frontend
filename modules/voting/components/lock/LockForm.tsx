        ...
        borderRadius="12px">
            <Box padding={{ base:'2', md:'2'}} borderRadius="12px" mb="6" >
                ...
                <Flex align="center" mt="6">
                            <Text fontSize="1rem" mr="auto">VRTK-WBNB</Text>
                            <Text fontSize="1rem" ml="auto">{userPoolBalance.balance}</Text>
                </Flex>
                <Flex align="center" mt="1" >
                        <Text fontSize="1rem" mr="auto">Vertek Governance</Text>
                        <Text fontSize="1rem" ml="auto">{userPoolBalance.usdValue}</Text>
                </Flex>
                <Flex  
                mt="8" >
                    <Button 
