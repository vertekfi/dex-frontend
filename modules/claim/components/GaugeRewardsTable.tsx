...
export function GaugeRewardsTable({ gauge }: Props) {
  ...
  return (
    <Box borderRadius="16px" mt={5}>
      <Box
        borderTopRadius="16px" borderBottomRadius={{base:'16px', lg:'none'}}
        overflow="hidden"
      ...
      <Box mb={{base:'none', lg:'10'}}>
        <Flex
          ...
          p="3"
          mt={0}
          borderLeftWidth="1px" borderRightWidth="1px" borderBottomWidth="1px" borderColor="#4A4AF6"
          borderBottomRadius="16px" borderTopRadius={{base:'16px', lg:'none'}}
