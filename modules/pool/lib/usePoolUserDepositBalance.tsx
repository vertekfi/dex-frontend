...
export const PoolUserDepositBalanceContext = createContext<ReturnType<
  typeof _usePoolUserDepositBalance
> | null>(null);
...
export function PoolUserDepositBalanceProvider(props: { children: ReactNode }) {
  ...
  return (
    <PoolUserDepositBalanceContext.Provider value={value}>
      {props.children}
    </PoolUserDepositBalanceContext.Provider>
  );
}
