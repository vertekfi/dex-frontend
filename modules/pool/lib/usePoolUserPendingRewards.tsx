...
export const PoolUserPendingRewardsContext = createContext<ReturnType<
  typeof _usePoolUserPendingRewards
> | null>(null);
...
export function PoolUserPendingRewardsProvider(props: { children: ReactNode }) {
  ...
  return (
    <PoolUserPendingRewardsContext.Provider value={value}>
      {props.children}
    </PoolUserPendingRewardsContext.Provider>
  );
}
